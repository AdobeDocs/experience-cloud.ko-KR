...
경험 롤아웃의 **application**&#x200B;은(는) 기능 플래그를 사용하여 제어할 서비스 또는 제품을 나타냅니다. 팀이 기능 플래그를 만들려면 먼저 하나 이상의 애플리케이션을 콘솔에 온보딩해야 합니다.

## 애플리케이션을 관리할 수 있는 사람 {#permissions}

**관리자** 역할을 가진 구성원만 응용 프로그램을 추가하거나 수정할 수 있습니다. 이 역할이 없는 경우 팀 관리자에게 문의하십시오.

## 응용 프로그램 추가 {#add-application}

팀에 응용 프로그램을 추가하려면 [응용 프로그램 온보딩](onboard-your-application.md)에서 단계별 지침을 참조하십시오.

## 팀 소유권 {#team-ownership}

각 애플리케이션은 정확히 하나의 팀이 소유합니다. 해당 팀의 멤버만 애플리케이션의 기능 플래그를 관리할 수 있습니다.
