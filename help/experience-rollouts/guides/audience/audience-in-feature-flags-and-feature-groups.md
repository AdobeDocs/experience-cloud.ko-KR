...
description: 컨텍스트 변수를 사용하여 Adobe Experience 롤아웃에서 기능 플래그 및 기능 그룹에 대한 대상 기준을 정의하는 방법을 알아봅니다.
...
경험 롤아웃은 기능 플래그 및 기능 그룹에 대한 대상 타깃팅을 제공합니다. 컨텍스트 변수를 결합하여 기능을 수신할 사용자를 정확하게 제어할 수 있습니다.
