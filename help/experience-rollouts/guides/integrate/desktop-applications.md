---
title: 데스크탑 애플리케이션
description: SDK을 사용하여 Adobe Experience Rollouts를 데스크탑 애플리케이션에 통합하는 방법을 알아봅니다.
...
데스크탑 애플리케이션은 SDK을 통해 Experience Rollouts와 통합됩니다. 데스크탑 스택과 관련된 통합 지침은 Adobe 담당자에게 문의하십시오.
