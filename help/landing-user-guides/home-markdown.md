...
| 사용 안내서 | 자습서 |
|--- |--- |
| <ul><li>[Target 안내서](https://docs.adobe.com/content/help/ko-KR/target/using/target-home.html)</li></ul> | <ul><li>[Target 자습서](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html)</li></ul> |

## ![아이콘](/help/assets/campaign.png) 캠페인

| 사용자 안내서 | 자습서 |
|--- |--- |
| <ul><li>[Campaign Standard](https://docs.adobe.com/content/help/ko-KR/campaign-standard/using/campaign-standard-home.html)</li><li>[Campaign Classic](https://docs.adobe.com/content/help/en/campaign-classic/using/campaign-classic-home.html)</li></ul> | <ul><li>[Campaign Classic 자습서](https://docs.adobe.com/content/help/ko-KR/campaign-learn/campaign-classic-tutorials/overview.html)</li><li>[Campaign Standard 자습서](https://docs.adobe.com/content/help/ko-KR/campaign-learn/campaign-standard-tutorials/overview.html)</li></ul> |

## ![아이콘](/help/assets/audience-manager.png) Audience Manager

| 사용 안내서 | 자습서 |
|--- |--- |
| <ul><li>[Audience Manager 사용 안내서](https://docs.adobe.com/content/help/ko-KR/audience-manager/user-guide/aam-home.html)</li></ul> | <ul><li>[Audience Manager 자습서](https://docs.adobe.com/content/help/en/audience-manager-learn/tutorials/overview.html)</li></ul> |
