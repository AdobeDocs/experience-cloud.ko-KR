...
그런 다음 필터, 순서 지정 및 페이지 매김을 사용하여 검색을 구체화할 수 있습니다. 자세한 내용은 [추가 작업](sorting.md) 섹션.
...
다음 **[!UICONTROL filterType]** 매개 변수를 사용하면 다음 필드 중 하나를 기반으로 프로필을 검색할 수 있습니다. 이메일, 이름, 성 또는 프로필 리소스를 확장할 때 고급 필터링에 추가된 사용자 지정 필드.
