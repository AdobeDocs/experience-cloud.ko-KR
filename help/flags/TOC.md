...
+ [개요](home.md)
+ 시작하기 {#get-started}
   + [플래그 소개](getting-started/introduction.md)
   + [플래그를 사용하는 이유](getting-started/why-use-flags.md)
   + [플래그 모드](getting-started/flags-modes.md)
+ 개념 {#concepts}
...
+ 플래그 통합 {#integrate}
   + [앱에 플래그 통합](guides/integrate/integrating-in-your-app.md)
...
+ SDK 릴리스 {#sdk-releases}
   + [Android 확장 통합 안내서](guides/sdk-releases/android/android-extension-integration-guide.md)
